...
source venv/bin/activate
    ...
    In uno avvia il server:

python3 peer1.py

    Nell’altro avvia il client:

python3 peer2.py

✅ Funzionalità

    Messaggi: inviati e ricevuti in chiaro nel campo grafico, criptati in transito.

    Emoji: cliccabili e integrate nei messaggi.

    Cronologia: salvata nei file chat_history.txt (max 200 messaggi).
